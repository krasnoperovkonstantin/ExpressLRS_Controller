...
{
#ifdef TARGET_TX_ESP32_LORA1280F27_Controller
    ChannelDataIn[0] = map ((analogRead(GPIO_PIN_TROTLE)+analogRead(GPIO_PIN_TROTLE)+analogRead(GPIO_PIN_TROTLE)) % 3, MAP_IN_MIN_ADC_TROTLE, MAP_IN_MAX_ADC_TROTLE, MAP_OUT_MIN_ADC_TROTLE, MAP_OUT_MAX_ADC_TROTLE);
    ChannelDataIn[1] = map ((analogRead(GPIO_PIN_YAW)+analogRead(GPIO_PIN_YAW)+analogRead(GPIO_PIN_YAW)) % 3, MAP_IN_MIN_ADC_YAW, MAP_IN_MAX_ADC_YAW, MAP_OUT_MIN_ADC_YAW, MAP_OUT_MAX_ADC_YAW);
    ChannelDataIn[2] = map ((analogRead(GPIO_PIN_PITCH)+analogRead(GPIO_PIN_PITCH)+analogRead(GPIO_PIN_PITCH)) % 3, MAP_IN_MIN_ADC_PITCH, MAP_IN_MAX_ADC_PITCH, MAP_OUT_MIN_ADC_PITCH, MAP_OUT_MAX_ADC_PITCH);
    ChannelDataIn[3] = map ((analogRead(GPIO_PIN_ROLL)+analogRead(GPIO_PIN_ROLL)+analogRead(GPIO_PIN_ROLL)) % 3, MAP_IN_MIN_ADC_ROLL, MAP_IN_MAX_ADC_ROLL, MAP_OUT_MIN_ADC_ROLL, MAP_OUT_MAX_ADC_ROLL);
    ChannelDataIn[4] = digitalRead(GPIO_PIN_AUX1);
    #ifdef ADC_AUX2
    ChannelDataIn[5] = map ((analogRead(GPIO_PIN_AUX2)+analogRead(GPIO_PIN_AUX2)+analogRead(GPIO_PIN_AUX2)) % 3, MAP_IN_MIN_ADC_AUX2, MAP_IN_MAX_ADC_AUX2, MAP_OUT_MIN_ADC_AUX2, MAP_OUT_MAX_ADC_AUX2); 
    #else
    ChannelDataIn[5] = digitalRead(GPIO_PIN_AUX2)*2048;
    #endif
    #ifdef ADC_AUX3
    ChannelDataIn[6] = map ((analogRead(GPIO_PIN_AUX3)+analogRead(GPIO_PIN_AUX3)+analogRead(GPIO_PIN_AUX3)) % 3, MAP_IN_MIN_ADC_AUX3, MAP_IN_MAX_ADC_AUX3, MAP_OUT_MIN_ADC_AUX3, MAP_OUT_MAX_ADC_AUX3); 
    #else
    ChannelDataIn[6] = digitalRead(GPIO_PIN_AUX3)*2048;
    #endif
    #ifdef ADC_AUX4
    ChannelDataIn[7] = map ((analogRead(GPIO_PIN_AUX4)+analogRead(GPIO_PIN_AUX4)+analogRead(GPIO_PIN_AUX4)) % 3, MAP_IN_MIN_ADC_AUX4, MAP_IN_MAX_ADC_AUX4, MAP_OUT_MIN_ADC_AUX4, MAP_OUT_MAX_ADC_AUX4); 
    #else
    ChannelDataIn[7] = digitalRead(GPIO_PIN_AUX4)*2048;
    #endif
    #ifdef ADC_AUX5
    ChannelDataIn[8] = map ((analogRead(GPIO_PIN_AUX5)+analogRead(GPIO_PIN_AUX5)+analogRead(GPIO_PIN_AUX5)) % 3, MAP_IN_MIN_ADC_AUX5, MAP_IN_MAX_ADC_AUX5, MAP_OUT_MIN_ADC_AUX5, MAP_OUT_MAX_ADC_AUX5); 
    #else
    ChannelDataIn[8] = digitalRead(GPIO_PIN_AUX5)*2048;
    #endif
    #ifdef ADC_AUX6
    ChannelDataIn[9] = map ((analogRead(GPIO_PIN_AUX6)+analogRead(GPIO_PIN_AUX6)+analogRead(GPIO_PIN_AUX6)) % 3, MAP_IN_MIN_ADC_AUX6, MAP_IN_MAX_ADC_AUX6, MAP_OUT_MIN_ADC_AUX6, MAP_OUT_MAX_ADC_AUX6);
    #else
    ChannelDataIn[9] = digitalRead(GPIO_PIN_AUX6)*2048;
    #endif
    #ifdef ADC_AUX7
    ChannelDataIn[10] = map ((analogRead(GPIO_PIN_AUX7)+analogRead(GPIO_PIN_AUX7)+analogRead(GPIO_PIN_AUX7)) % 3, MAP_IN_MIN_ADC_AUX7, MAP_IN_MAX_ADC_AUX7, MAP_OUT_MIN_ADC_AUX7, MAP_OUT_MAX_ADC_AUX7); 
    #else
    ChannelDataIn[10] = digitalRead(GPIO_PIN_AUX7)*2048;
    #endif
    #ifdef ADC_AUX8
    ChannelDataIn[11] = map ((analogRead(GPIO_PIN_AUX8)+analogRead(GPIO_PIN_AUX8)+analogRead(GPIO_PIN_AUX8)) % 3, MAP_IN_MIN_ADC_AUX8, MAP_IN_MAX_ADC_AUX8, MAP_OUT_MIN_ADC_AUX8, MAP_OUT_MAX_ADC_AUX8); 
    #else
    ChannelDataIn[11] = digitalRead(GPIO_PIN_AUX8)*2048;
    #endif 

    ChannelDataIn[12] = 1024;
    ChannelDataIn[13] = 1024;
    ChannelDataIn[14] = 1024;
    ChannelDataIn[15] = 1024;
...
#ifndef TARGET_TX_ESP32_LORA1280F27_Controller
void ICACHE_RAM_ATTR CRSF::GetADCValue(pin)
{
